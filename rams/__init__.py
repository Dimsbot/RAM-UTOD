...
IG_ALIVE = os.environ.get("IG_ALIVE") or "instagram.com/banh_dims0"
...
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/dimzbotzzxyz"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/sansdimz"
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@Rams"):
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/dimzbotzzxyz"),
                            custom.Button.url(
